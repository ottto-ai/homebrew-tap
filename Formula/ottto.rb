# Generated from ottto-local-platform 0.1.17 (stable).
...
class Ottto < Formula
  ...
  url "https://install.ottto.net/ottto-local-platform/releases/stable/0.1.17/ottto-macos-arm64.zip"
  version "0.1.17"
  sha256 "ae9462129428853edcb943c352a1e007eaef24798469ef5e45a0c681787a2344"
  license "Apache-2.0"
  ...
  resource "ottto-service" do
    url "https://install.ottto.net/ottto-local-platform/releases/stable/0.1.17/ottto-service-macos-arm64.zip"
    sha256 "f1bcd0ed986ac732f323d0b23f2035ae9dd7c44da467bd1e1fef6207dad841b9"
  end
